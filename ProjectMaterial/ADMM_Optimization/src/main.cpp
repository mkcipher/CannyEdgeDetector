...
int main(int argc, char** argv)
{
    ...
    float psfWidth = 3;
    float w = 1; // window size, can be tuned but odd number
    float alpha = 0.4; // alpha in matrix gamma, can be tuned
    float sigma = 6; // required parameter in the cost function
    float lambda = 0.1; // the weight for regularization term
    float Rho = 0.01; // required parameter in the ADMM
    ...
    /***** ToDo: Implement optimizator (ADMM) to solve given cost function, including calculate the gradient... ******/
